...
- **Ship a release from CI:** push a version tag, e.g. `git tag v1.2.2 && git push origin v1.2.2` — [Release Windows](.github/workflows/release-windows.yml) builds and uploads the zip and installer to that release.
